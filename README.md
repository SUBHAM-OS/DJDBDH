...
`git clone https://github.com/The-SUBHAM-OS/LEGENDUSERBOT.git`
- Open Cloned Folder.
...
Poject [LEGENDBOT](https://github.com/SUBHAM-OS/LEGENDBOT) is free software: you can redistribute it and/or modify
